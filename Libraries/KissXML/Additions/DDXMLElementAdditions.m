...
- (DDXMLElement *)elementForName:(NSString *)name
{
	...
	{
		// Note: If you port this code to work with Apple's DDXML, beware of the following:
		// 
		// There is a bug in the DDXMLElement elementsForName: method.
...
- (void)setXmlns:(NSString *)ns
{
	...
	// 
	// This applies to both Apple's DDXML and DDXML.
