...
@interface DDXMLNamespaceNode : DDXMLNode
{
	...
	// This is here to fix the problem, and make this class more compatible with the DDXML classes.
...
@interface DDXMLAttributeNode : DDXMLNode
{
	...
	// 
	// This is here to maintain compatibility with the DDXML classes,
