...
- (void)testElement {
    ...
    STAssertEqualObjects( collString, @"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<collection xmlns=\"http://www.w3.org/2007/app\"></collection>", nil );
}
